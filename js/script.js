...
bindPress(jumpBtn, handleJumpStart);
bindPress(shootBtn, handleShootStart);
bindPress(startBtn, finishSetup);
bindPress(restartBtn, resetGame);
bindPress(resumeBtn, togglePause);
bindPress(pauseBtn, togglePause);
bindPress(musicToggleBtn, toggleMusic);
